...
public class StarInvaders extends Game {
    ...
    public void create() {
        ...
        //Init main font
        FreeTypeFontGenerator generator = new FreeTypeFontGenerator(Gdx.files.internal("fonts/zorque.ttf"));
        FreeTypeFontParameter parameter = new FreeTypeFontParameter();
        parameter.size = 128;
        fontMain = generator.generateFont(parameter); // fontMain size 12 pixels

        //Init labelFont
        generator = new FreeTypeFontGenerator(Gdx.files.internal("fonts/pdark.ttf"));
