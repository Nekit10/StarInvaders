...
public class GLScreen implements Screen {
    ...
    public GLScreen(StarInvaders game, SettingsRenderScreen menu) throws IOException {
        ...
        label = prop.getProperty("settings.opengl.label");
        menuLables = prop.getProperty("settings.opengl.elements").split(";");

        prop.load(new FileInputStream("properties/settings/opengl.properties"));
    ...
    public void render(float delta) {
        ...
        int npos = (int) game.settingsGame.get("gl", 1);
